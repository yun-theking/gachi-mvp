    ...
    <div className="fixed inset-0 z-[100] flex flex-col bg-bg">
      <div className="sticky top-0 bg-bg/95 backdrop-blur border-b border-border">
        <div className="max-w-xl mx-auto px-4 py-4 flex flex-col gap-1">
          <div className="flex items-center justify-between">
            <h2 className="font-serif text-xl font-bold text-text">{t.questionListTitle}</h2>
            <button
              onClick={closeList}
          ...
          <p className="text-sm text-text-dim">{t.questionListSubtitle}</p>
          {questions && (
            <p className="text-sm text-accent-dark font-semibold mt-1">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-xl mx-auto px-4 py-4 flex flex-col gap-6">
          {loadError && <p className="text-base text-danger">{t.networkErrorMessage}</p>}
